...
# BAB: dont call real_data in the function itself!

##########################################################################
#PREPARE DATA - AGE ONLY
##########################################################################
#SHELLS
make_list_data_age <- function(data, foraging_type ){
...
# xlsx rJava rrepast RNetLogo
# ERROR: dependency ‘rJava’ is not available for package ‘xlsxjars’
# ERROR: dependency ‘rJava’ is not available for package ‘RNetLogo’

##########################################################################
#PREPARE DATA - ALL PREDICTORS
##########################################################################
make_list_data_all <- function(data, foraging_type ){
